...
## Project Structure
    ...
    ├── resurgence_staythec_31100  # Django project configurations
...
1. Clone this repo and `cd resurgence_staythec_31100`
...
2. Clone this repo and `cd resurgence_staythec_31100`
